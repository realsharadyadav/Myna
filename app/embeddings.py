...
def _resolve_embedding_model(db_default: str = "") -> str:
    """Return the embedding model string to use, falling back to the
    hardcoded default if no DB setting is configured."""
    if db_default:
        return db_default
